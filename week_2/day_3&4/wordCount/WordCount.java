...
public class WordCount{
	...
	public void putInFile(){
		File output= new File("/home/cb-archit/work/java_prac/week_2/day_3&4/wordCount/output.txt");
		PrintWriter pw;
		try{
	...
	public static void main(String[] args){
		WordCount obj= new WordCount("/home/cb-archit/work/java_prac/week_2/day_3&4/wordCount/sample.txt");
		obj.readFile();
		obj.putInFile();
	}
}
